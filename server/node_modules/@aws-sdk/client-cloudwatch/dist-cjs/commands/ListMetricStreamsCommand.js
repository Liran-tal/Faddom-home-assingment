...
class ListMetricStreamsCommand extends smithy_client_1.Command {
    ...
    serialize(input, context) {
        return (0, Aws_query_1.serializeAws_queryListMetricStreamsCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_query_1.deserializeAws_queryListMetricStreamsCommand)(output, context);
    }
}
