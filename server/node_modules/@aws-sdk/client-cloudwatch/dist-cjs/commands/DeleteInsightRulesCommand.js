...
class DeleteInsightRulesCommand extends smithy_client_1.Command {
    ...
    serialize(input, context) {
        return (0, Aws_query_1.serializeAws_queryDeleteInsightRulesCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_query_1.deserializeAws_queryDeleteInsightRulesCommand)(output, context);
    }
}
